...
echo  ______                          
echo /\__  _\
echo \/_/\ \/    __    ___ ___   _____       Wersja: 1.0.1
...
echo                               \ \_\     zawartość folderów Temp, które mogą 
echo                                \/_/     zapełniać pamięć na dysku.                        
goto kommm
...
echo Dosłownie to samo co %Temp%; ale mogą jeszcze się tam znaleźć po instalacjach
echo np. aktualizacji. Dlatego ten program został zrobiony, żeby je usuwać!
echo.
